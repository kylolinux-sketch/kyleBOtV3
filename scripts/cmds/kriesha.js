...
module.exports = {
  config: {
    ...
    guide: "•kriesha on | off | <message> | (reply to image)"
  },
    ...
    try {
      ...
      if (action === "on") {
        ...
        return api.sendMessage(
          "✅ kriesha your ai girlfriend is now ON.",
          event.threadID,
          event.messageID
        );
      }
      ...
      if (action === "off") {
        simEnabled = false;
        return api.sendMessage(
          "❌ kriesha your ai girlfriend is now OFF.",
          event.threadID,
          event.messageID
        );
      }
      ...
      console.error("[Kriesha onStart ERROR]", err);
    }
  },
  ...
  onChat: async function ({ api, event }) {
    try {
      ...
      console.log("[Kriesha AUTO]", { body, imageUrl });
      ...
      console.error("[Kriesha onChat ERROR]", err);
    }
  }
};
